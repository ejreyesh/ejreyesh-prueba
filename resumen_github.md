# Creación de una cuenta GitHub, generación de un token de acceso y su enlace con Google Authenticator
> Las instrucciones que a continuación se presentan, tienen como objetivo principal conseguir el registro de una cuenta GitHub y la creación de un token de acceso para que posteriormente sea enlazado con Google Authenticator con la intención de emplearlo como método de acceso a la cuenta y así aumentar la seguridad de la misma.
<p align="center">
...
2. **Si aún no tienes una cuenta de GitHub accede a la opción “Sign up” y espera a que cargue la página.**
    <p align="center">
    ...
    3. En el campo “**Create a password**” ingresar la contraseña de la cuenta y dar clic sobre el botón “**Continue**”. 
    ...
    16. En la nueva página mostrada por GitHub, seleccionar el plan que mejor se adapta a tus necesidades como usuario. Existen dos planes, uno que es gratuito y otro que es de paga. Dependiendo de la decisión tomada, presionar el botón que se ubica al término de la lista de características que posee cada una de las ofertas. En este caso se presiona el botón “**Continue for free**”.
    17. Una vez que la cuenta se dió de alta correctamente, el sistema de GitHub muestra una animación y posteriormente despliega el panel principal de la cuenta.
3. **Cuando ya se tenga una cuenta de GitHub, ingresar en la opción “Sign in”, esto mostrará el formulario de acceso a la cuenta.**
    <p align="center">
...
4. **Para crear el token de GitHub es necesario ya haber ingresado a la cuenta.**
    ...
    1. En el campo “**Expiration**” ingresar la fecha de caducidad. 
    ...
    5. Cuando el token sea generado, resguardarlo en un lugar seguro para su uso posterior.
        > La razón por la cual se pide resguardar el token, es debido a que, solo se puede visualizar una vez.
...
5. **Activación de la autenticación en dos pasos de GitHub (2FA).**
    ...
    1. En la página mostrada en el navegador de la computadora, presionar el botón “**Download**” que aparece al término de los códigos de recuperación de la cuenta.
